...
function delegate(callingObj, methodOwner, methodName) {
  return function () {
    return methodOwner[methodName].apply(callingObj, arguments);
  };
}


function extend(func, mixin) {
  let methodName = Object.keys(mixin);

  methodName.forEach(function (name) {
    func[name] = delegate(func, mixin, name);
  });
